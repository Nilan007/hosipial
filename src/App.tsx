...
import Accounting from './pages/billing/Accounting';
...
import FasttrackSubscription from './pages/patients/FasttrackSubscription';
import OutsideLabCommission from './pages/billing/OutsideLabCommission';
      ...
      <AuthProvider>
        <Router>
          <Routes>
            ...
            <Route path="/fasttrack" element={<PrivateRoute><FasttrackSubscription /></PrivateRoute>} />
            <Route path="/outside-labs" element={<PrivateRoute><OutsideLabCommission /></PrivateRoute>} />
            ...
            <Route path="/staff" element={<PrivateRoute><StaffHR /></PrivateRoute>} />
            <Route path="/inventory" element={<PrivateRoute><SuperModule /></PrivateRoute>} />
            <Route path="/assets" element={<PrivateRoute><SuperModule /></PrivateRoute>} />
